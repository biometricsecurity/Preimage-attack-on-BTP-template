...
for dimensions=[16 32 64 100 200 300 400 500 ]
    ...
    load(['data/iomhashing_reconstructnoconstraint_',num2str(dimensions),'.mat'],'reconstruct_x');
    load(['data/iomhashing_eer_',num2str(dimensions),'.mat'],'EER_HASH');
    ...
    fid=fopen('logs/iomnoconstraint.log','a');
    fprintf(fid,str_log);
    fclose(fid);
end