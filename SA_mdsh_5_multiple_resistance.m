...
for dimensions=[256 ]
    for jjj=1:1
        ...
        SHparamNew1.alpha=0.9; %0.1 -1.0
        SHparamNew1.nbits = hamming_dimension; % number of bits to code each sample 5 bits 10240
        
%         load(['data/nmdsh/',num2str(SHparamNew1.alpha),'/20190620nmdsh_reconstruct_',num2str(SHparamNew1.nbits),'_',num2str(jjj),'.mat'],'reconstruct_x');
%         load(['data/nmdsh/',num2str(SHparamNew1.alpha),'/20190620nmdsh_eer_',num2str(SHparamNew1.nbits),'_',num2str(jjj),'.mat'],'EER_HASH');
%         load(['data/nmdsh/',num2str(SHparamNew1.alpha),'/20190620SHparam_',num2str(SHparamNew1.nbits),'_',num2str(jjj),'.mat'],'SHparamNew1');
%         load(['data/nmdsh/',num2str(SHparamNew1.alpha),'/20190620randnum_',num2str(SHparamNew1.nbits),'_',num2str(jjj),'.mat'],'randnum');
        ...
        for a=1:158
            reconstruct_x(a,:)=reconstruct_x(a,:)/randnum;
        end
        ...
        fid=fopen('logs/070111mdsh_multi.log','a');
        fprintf(fid,str_log);
        fclose(fid);
        ...
        fid=fopen('logs/070111mdsh_biohashing_multi.log','a');
        fprintf(fid,str_log);
        fclose(fid);
...
%         reconstruct_x = reconstruct_x./ sum(reconstruct_x,2); % what is we normlized it
        ...
        fid=fopen('logs/070111mdsh_iom_multi.log','a');
        fprintf(fid,str_log);
        fclose(fid);
