...
for dimensions=[500 ]
    for jjj=1:5
        ...
        load(['data/biohashing/20190620biohashing_reconstruct_',num2str(hamming_dimension),'_',num2str(jjj),'.mat'],'reconstruct_x');
        load(['data/biohashing/20190620biohashing_eer_',num2str(hamming_dimension),'_',num2str(jjj),'.mat'],'EER_HASH');
        ...
        fid=fopen('logs/0701biohashing_multi.log','a');
        fprintf(fid,str_log);
        fclose(fid);
        ...
        fid=fopen('logs/0701biohashing_iom_multi.log','a');
        fprintf(fid,str_log);
        fclose(fid);
        ...
        fid=fopen('logs/0701biohahsing_mdsh_multi.log','a');
        fprintf(fid,str_log);
        fclose(fid);
