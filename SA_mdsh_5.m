...
for bits=[ 10 50 128 256 512 1024 2048 4096 10240]
    ...
    for i=1:158
        ...
        to_retrieve_hash=hashed_code_gallery((i-1)*10+1,:); % first of the template are used to reconstruct
    ...
    save(['data/nmdsh/',num2str(SHparamNew1.alpha),'/nmdsh_reconstruct_',num2str(SHparamNew1.nbits),'.mat'],'reconstruct_x');
    save(['data/nmdsh/',num2str(SHparamNew1.alpha),'/nmdsh_eer_',num2str(SHparamNew1.nbits),'.mat'],'EER_HASH');
    save(['data/nmdsh/',num2str(SHparamNew1.alpha),'/SHparam_',num2str(SHparamNew1.nbits),'.mat'],'SHparamNew1');
    save(['data/nmdsh/',num2str(SHparamNew1.alpha),'/randnum_',num2str(SHparamNew1.nbits),'.mat'],'randnum');
