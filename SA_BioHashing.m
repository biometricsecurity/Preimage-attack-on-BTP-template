...
for dimensions=[16 32 64 100 200 300 400 500 ]
    ...
    save(['data/biohashing/biohashing_reconstruct_',num2str(hamming_dimension),'.mat'],'reconstruct_x');
    save(['data/biohashing/biohashing_eer_',num2str(hamming_dimension),'.mat'],'EER_HASH');
